...
set output "instantrestart_zoom".fnum.".tex"
...
plot file using (column(0)):(column(1)/1000):(column(2)/1000) with filledcurves above notitle lc rgb '#1B9E77', \
    '' using (column(0)):(column(1)/1000):(column(2)/1000) with filledcurves below notitle lc rgb '#d95f02', \
    '' using (column(0)):(column(1)/1000) with lines ls 1 title "ARIES restart", \
    '' using (column(0)):(column(2)/1000) with lines ls 2 title "Instant restart"
